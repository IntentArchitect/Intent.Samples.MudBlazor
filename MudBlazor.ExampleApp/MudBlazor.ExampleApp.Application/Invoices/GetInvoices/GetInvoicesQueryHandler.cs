...
namespace MudBlazor.ExampleApp.Application.Invoices.GetInvoices
{
    ...
    public class GetInvoicesQueryHandler : IRequestHandler<GetInvoicesQuery, Common.Pagination.PagedResult<InvoiceDto>>
    {
        ...
        public async Task<Common.Pagination.PagedResult<InvoiceDto>> Handle(
