...
using MudBlazor.ExampleApp.Application.Invoices.UpdateInvoice;
...
namespace MudBlazor.ExampleApp.Api.Controllers
{
    ...
    public class InvoicesController : ControllerBase
    {
        ...
        public async Task<ActionResult<InvoiceDto>> GetInvoiceById(
            ...
            CancellationToken cancellationToken = default)
        {
            var result = await _mediator.Send(new GetInvoiceByIdQuery(id: id, pageNo: pageNo, pageSize: pageSize, orderBy: orderBy), cancellationToken);
